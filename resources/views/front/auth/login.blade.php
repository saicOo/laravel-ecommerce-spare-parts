                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        @lang('site.login')/@lang('site.register')</li>
                                </ol>
                            </nav>
                            <!--End Breadcrums-->
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <div class="form-group">
                                                <input type="email" name="email" placeholder="{{ __('site.email') }}*"
                                                    id="CustomerEmail"
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <div class="form-group">
                                                <input type="password" value="" name="password"
                                                    placeholder="{{ __('site.password') }}*" id="CustomerPassword"
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 mb-3">
                                            <label>
                                                <input
                                                    class="d-inline-block align-middle mb-0 mt-0 margin-5px-right form-check-input"
                                                    type="checkbox" name="remember">
                                                <span
                                                    class="d-inline-block align-middle mx-2">{{ __('site.Remember Me') }}</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div
                                            class="text-left col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                                            <input type="submit" class="btn rounded btn-primary btn-lg"
                                                value="{{ __('site.login') }}">
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div class="box box-register">
                                <form method="post" action="{{ route('register') }}" class="register-form">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 mb-3">
                                            <div class="form-group">
                                                <input id="CustomerPassword1" type="password" name="password"
                                    ...
                                    <div class="row">
                                        <div class="text-start col-12 col-sm-12 col-md-6 col-lg-6">
                                            <input type="submit" class="btn btn-lg btn-primary rounded"
                                                value="{{ __('site.register_now') }}">
                                        </div>
                                    </div>
                                </form>
                            </div>
