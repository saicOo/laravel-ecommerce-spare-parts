    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="row justify-content-between mb-3">
                <div class="col-12 ">
                    <h2 class="page-heading">{{ __('site.list') }} {{ __('site.admins') }}</h2>
                    <p class="mb-0">{{ __('site.count') }} {{ __('site.admins') }} : {{ $admins->total() }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-header row">
                                <div class="col-md-6">
                                    <a href="{{route('dashboard.admins.create')}}" class="btn btn-primary mb-2">{{ __('site.create') }}</a>
                                    <button type="button" class="btn btn-primary mb-2" data-toggle="modal"
                                        data-target="#filterModal">{{ __('site.filter') }}</button>
                                    <form action="{{ route('dashboard.admins.destroy', 'delete') }}" method="post"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        ...
                                                        <a href="{{ route('dashboard.admins.permissions.edit', $admin->id) }}"
                                                            class="mr-4" data-toggle="tooltip" data-placement="top"
                                                            title="" data-original-title="Permissions"><i
                                                                class="fa fa-key color-muted"></i> </a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('site.filter') }} {{ __('site.admins') }}</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('dashboard.admins.index') }}" method="GET" id="filter-form">
