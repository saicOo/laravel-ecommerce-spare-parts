                ...
                <div class="col-xxl-12 col-xl-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h4 class="card-title">@lang('site.edit') @lang('site.car')</h4>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('dashboard.cars.update',$car->id) }}">
                                {{ csrf_field() }}
                                {{ method_field('put') }}
                                <div class="form-row">
                                    <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                <option value="{{$i}}" {{ $i == $car->start_year ? 'selected': ''}}>{{$i}}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                @for ($i = date("Y"); $i > 1900; $i--)
                                                <option value="{{$i}}" {{ $i == $car->end_year ? 'selected': ''}} >{{$i}}</option>
                                                @endfor
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="factory_car_id" class="single-select"  >
                                                ...
                                                @foreach ($factory_cars as $factory_car)
                                                    <option value="{{$factory_car->id}}" {{ $factory_car->id == $car->factoryCar->id ? 'selected': ''}}>{{ $factory_car->name }}</option>
                                                @endforeach
                                            </select>
