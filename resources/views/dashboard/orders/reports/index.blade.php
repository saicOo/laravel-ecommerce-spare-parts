    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="row justify-content-between mb-3">
                <div class="col-12 ">
                    <h2 class="page-heading">{{ __('site.list') }} {{ __('site.reports') }} {{ __('site.orders') }}</h2>
                                    ...
                                    <tbody>
                                        @foreach ($reports as $index => $report)
                                            <tr>
                                                ...
                                                <td><a href="{{route('dashboard.orders.index',['date'=> $report->created_at->format('Y-m-d')])}}">@lang('site.show')</a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('dashboard.report-orders') }}" method="GET" id="filter-form">
