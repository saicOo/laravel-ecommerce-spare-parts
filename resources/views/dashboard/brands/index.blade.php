    ...
    <div class="modal fade" id="excelModal" style="display: none;" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('dashboard.import-brands') }}" method="POST" enctype="multipart/form-data" id="excel-form">
                        @csrf
                        <div class="form-group">
                ...
                <a class="btn btn-warning" href="{{ route('dashboard.export-brands') }}">
                    @lang('site.export')
                </a>
                </div>
            </div>
